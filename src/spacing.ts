 ...
 */
 ...
 export const spacing = [0, 4 * screenPercent, 8 * screenPercent, 12 * screenPercent, 16 * screenPercent, 24 * screenPercent, 32 * screenPercent, 48 * screenPercent, 64 * screenPercent]
